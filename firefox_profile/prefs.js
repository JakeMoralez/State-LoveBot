...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1774341358);
user_pref("app.update.lastUpdateTime.background-update-timer", 1774341358);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1774341358);
user_pref("app.update.lastUpdateTime.region-update-timer", 1774341358);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1774341330);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1774341358);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1774341358);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "d40421d0-61a3-4fe6-b23c-50490482a9d9");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1774341329);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{14f5c216-6ff5-4f32-8142-6a0fed9746f1}");
...
user_pref("browser.startup.lastColdStartupCheck", 1774341330);
...
user_pref("browser.urlbar.lastUrlbarSearchSeconds", 1774341419);
user_pref("browser.urlbar.placeholderName", "Google");
user_pref("browser.urlbar.quicksuggest.migrationVersion", 6);
user_pref("browser.urlbar.suggest.searches", false);
user_pref("browser.usedOnWindows10.introURL", "");
user_pref("browser.warnOnQuit", false);
user_pref("captchadetection.lastSubmission", 1774341);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "71520cb4-c856-4d13-9d23-d1e1f43e7fa5");
user_pref("datareporting.dau.cachedUsageProfileID", "a5fd8e0d-aa7e-48fb-900c-9e7c9389e5d2");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"d6e350e9-d590-40f3-be12-032f16780349\",\"formautofill@mozilla.org\":\"09b1c94c-b246-4acc-a219-e1bd7c14e3c7\",\"ipp-activator@mozilla.com\":\"cf5daf1f-50c4-4fa8-999c-4f504b9256f5\",\"pictureinpicture@mozilla.org\":\"ad4da931-a553-46ab-b455-b680c80601cb\",\"addons-search-detection@mozilla.com\":\"bbcedc7b-ceb8-49d8-a4fe-d734b0f7a970\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"e22ceb2a-95a0-4539-82a6-c30d433e6b6e\",\"default-theme@mozilla.org\":\"006cfae0-7bf5-4bfa-a1f4-86a5bcd25929\"}");
...
user_pref("media.gmp-manager.lastCheck", 1774341384);
user_pref("media.gmp-manager.lastEmptyCheck", 1774341384);
user_pref("media.gmp-manager.updateEnabled", false);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("media.videocontrols.picture-in-picture.video-toggle.first-seen-secs", 1774341339);
...
user_pref("nimbus.profileId", "c9c0fe36-9aad-411b-bf25-badb33a8ed47");
...
user_pref("toolkit.profiles.storeID", "8144528e");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1774341326);
