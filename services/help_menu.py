...
HELP_CATEGORIES: tuple[HelpCategory, ...] = (
    ...
    HelpCategory(
        ...
        (
            ...
            HelpEntry("/academy", "Академия: профиль, задания, рейтинг", AccessLevel.SUPERVISOR),
            HelpEntry("/academy submit", "Сдать задание академии", AccessLevel.SUPERVISOR),
    ...
    HelpCategory(
        ...
        (
            ...
            HelpEntry("/poolkick", "Исключить из бесед (выбор scope)", AccessLevel.SUPERVISOR),
            ...
            HelpEntry("/del", "Удалить сообщение(я)", 2),
